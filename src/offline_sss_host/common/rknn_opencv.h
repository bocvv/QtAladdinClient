#ifndef __RKNN_OPENCV_H__
#define __RKNN_OPENCV_H__
...
class rknn_opencv {
    ...
    int one_frame_size; // [Xiao]
    struct rknn_out_data out_data; // [Xiao]
    char * input_data_buf; // [Xiao]
    ...
    int (*detect_img_func) (void *ctx, char * resize,
                struct rknn_out_data * out_data);
    ...
    int start(int (*get_img)
          ...
          int (*detect_img) (void *ctx, char * resize,
                     struct rknn_out_data * out_data),
