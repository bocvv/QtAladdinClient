/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Sat 10 Oct 2020 12:21:53 PM CST
 ************************************************************************/
...
const char config_file[] = "/root/wangbw/work/aladdin_client/client.conf";
std::unique_ptr<Config> conf(new Config(config_file));
